...
export default function Queues() {
  ...
  return (
    <div className="MY AIO-page">

      {/* HEADER */}
      <div className="MY AIO-page-header">
        <div>
          <h1 className="MY AIO-title">Call Queues</h1>
      ...
      {/* MAIN CARD */}
      <div className="MY AIO-card p-6 bg-white rounded-3xl shadow-xl border-2 border-gray-200">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="relative w-96">
            ...
            <input
              ...
              className="MY AIO-input pl-14 pr-4 py-3 rounded-2xl shadow-inner"
      ...
      {showModal && (
        ...
        >
          <div
            className="MY AIO-modal max-w-xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="MY AIO-modal-header">
              <h2 className="MY AIO-modal-title">Create New Queue</h2>
            ...
            <form onSubmit={handleCreateQueue} className="p-6 space-y-8">
              ...
              <button
                type="submit"
                className="MY AIO-btn-primary w-full py-3 text-lg rounded-2xl"
              >
                Create Queue
              </button>
            </form>
