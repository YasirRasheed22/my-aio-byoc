  ...
  return (
    <div className="MY AIO-page">
      ...
      <div className="MY AIO-page-header">
        <div>
          <h1 className="MY AIO-title">Extensions</h1>
      ...
      {showDrawer && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-end z-50"
          ...
          <div
            className="w-[450px] h-full bg-white shadow-2xl border-l-2 border-gray-200 p-5 overflow-y-auto MY AIO-modal"
            ...
            {step === 1 && (
              <div>
                ...
                <button
                  disabled={!form.type}
                  onClick={() => setStep(2)}
                  className="MY AIO-btn-primary w-full py-3 mt-5"
                >
                  Next <ChevronRight />
                </button>
              </div>
            ...
            {step === 2 && (
              <div>
                ...
                <div className="flex justify-between mt-5">
                  <button
                    onClick={() => setStep(1)}
                    className="MY AIO-btn-secondary flex items-center gap-2"
                  >
                    <ChevronLeft /> Back
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => setStep(3)}
                    className="MY AIO-btn-primary flex items-center gap-2"
                  >
                    Next <ChevronRight />
                  </button>
                </div>
