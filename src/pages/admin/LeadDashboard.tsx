  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-4 px-3">
        ...
        <Link style={{
          textDecoration:'none'
        }} to={'/leads/add-lead'} className="px-3 py-2 MY AIO-btn-primary rounded">Add New </Link>
        </div>
                ...
                <tr>
                  <td colSpan={activeTab === "leads" ? 5 : 5} className="px-6 py-24 text-center">
                    <div className="flex flex-col items-center">
                      <div className="MY AIO-spinner mb-4" />
          ...
          <div className="px-3 py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50">
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="MY AIO-input border border-gray-300 rounded-md px-1 py-1 text-sm focus:ring-orange-500 focus:border-orange-500"
              >
                {[10, 20, 30, 50].map((n) => (
