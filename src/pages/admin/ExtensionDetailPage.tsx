  ...
  return (
    <div className="MY AIO-page">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="MY AIO-title">Extension {extension.number}</h1>
      ...
      {/* TAB NAVIGATION */}
      <div className="MY AIO-tabs flex mb-8">
        {tabs.map((tab) => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id)}
            className={`MY AIO-tab ${
              activeTab === tab.id ? "MY AIO-tab-active" : ""
            }`}
          >
...
function ProfileTab({ extension }) {
  return (
    <div className="MY AIO-card p-6 rounded-3xl shadow-xl border-2 border-gray-200">
...
function RoutingTab({ extension }) {
  return (
    <div className="MY AIO-card p-6 rounded-3xl border-2 shadow-xl">
      ...
      <button className="MY AIO-btn-primary mt-8 px-10 py-3 text-lg">
        Save Routing
      </button>
    </div>
  )
...
function VoicemailTab({ extension }) {
  return (
    <div className="MY AIO-card p-6 rounded-3xl shadow-xl border-2">
      ...
      <div className="grid gap-5">
        {extension.devices.map((d) => (
          ...
          >
            ...
            <button className="MY AIO-btn-secondary">Reset</button>
          </div>
        ))}
      </div>
    </div>
