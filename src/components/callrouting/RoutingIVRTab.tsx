  ...
  const [ivrList, setIvrList] = useState([
    {
      id: 1,
      name: "Main IVR",
      prompt: "Welcome to MY AIO. Press 1 for Sales, 2 for Support.",
      options: [
    ...
    <div className="space-y-10 p-3">
      ...
      <div className="space-y-8 mt-3">
        {ivrList.map(ivr => (
          <div
            key={ivr.id}
            className="MY AIO-card p-3 rounded-3xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition mt-2" 
          >
            {/* HEADER */}
            ...
            {/* AUDIO UPLOAD */}
            <div className="mt-4">
              <button className="MY AIO-btn-secondary flex items-center gap-3 px-5 py-2">
                <Upload size={18} />
                Upload New Prompt
              </button>
            </div>
