  ...
  return (
    <div className="space-y-8 p-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="MY AIO-btn-primary flex items-center gap-3 px-6 py-3 text-lg">
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-3">
        {schedules.map(schedule => (
          <div
            key={schedule.id}
            className="MY AIO-card p-3 rounded-3xl border-2 border-gray-200 shadow-xl hover:shadow-2xl transition"
          >
