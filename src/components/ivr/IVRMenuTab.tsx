    ...
    <div className="space-y-8 p-3">
      ...
      <div className="space-y-6">
        {menu.map((item, i) => (
          <div
            key={i}
            className="MY AIO-card p-3 mt-2 border-2 rounded-3xl shadow-xl space-y-4"
          >
            {/* HEADER */}
            ...
            <div>
              ...
              <input
                ...
                className="MY AIO-input w-60 mt-2"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="MY AIO-input mt-2 w-60"
              >
                {actions.map((a) => (
      ...
      <button
        onClick={addKey}
        className="MY AIO-btn-primary px-6 py-3 text-lg flex items-center gap-3 rounded-2xl shadow-xl hover:scale-105 mt-3"
      >
