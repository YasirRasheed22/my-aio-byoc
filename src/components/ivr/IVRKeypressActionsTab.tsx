  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="MY AIO-btn-primary flex items-center gap-3 px-6 py-3 text-lg"
      ...
      {/* Table */}
      <div className="MY AIO-card p-6 rounded-3xl border-2 border-gray-200 bg-white shadow-xl overflow-x-auto">
      ...
      {/* Modal */}
      {showModal && (
        <div className="MY AIO-modal-backdrop">
          <div className="MY AIO-modal max-w-xl" onClick={(e) => e.stopPropagation()}>
            <div className="MY AIO-modal-header">
              <h2 className="MY AIO-modal-title">
                {editIndex !== null ? "Edit Keypress" : "Add New Keypress"}
              </h2>
              <button className="MY AIO-close-btn" onClick={() => setShowModal(false)}>
                ✕
              </button>
            </div>

            <div className="MY AIO-modal-body space-y-8">
            ...
            <div className="MY AIO-modal-footer">
              <button className="MY AIO-btn-secondary" onClick={() => setShowModal(false)}>
                Cancel
              </button>
              <button className="MY AIO-btn-primary" onClick={handleSave}>
                Save
              </button>
            </div>
