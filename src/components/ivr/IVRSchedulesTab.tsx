...
export default function IVRSchedulesTab() {
  ...
  return (
    <div className="space-y-10 p-3">
      ...
      {/* HOLIDAY SCHEDULES */}
      <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-8 mt-3">
        ...
        <button
          onClick={addHoliday}
          className="MY AIO-btn-primary px-6 py-3 text-lg flex items-center gap-3 mt-4"
        >
