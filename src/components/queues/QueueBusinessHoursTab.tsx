  ...
  return (
    <div className="space-y-10 p-4">
      ...
      <button
        ...
        className="MY AIO-btn-secondary px-6 py-3 flex items-center gap-3 rounded-2xl mt-3 mb-3"
      >
      ...
      <div className="space-y-6">
        {days.map((day) => (
          <div
            key={day}
            className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-4 mt-2   "
          >
            {/* HEADER */}
            ...
            {schedule[day].length > 0 && (
              <button
                ...
                className="MY AIO-btn-secondary px-4 py-2 text-sm flex items-center gap-2 mt-3"
              >
