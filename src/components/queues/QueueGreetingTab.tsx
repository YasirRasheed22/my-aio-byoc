...
export default function QueueGreetingTab() {
  ...
  return (
    <div className="space-y-10 p-4">
      ...
      {/* UPLOAD */}
      {!uploadedFile && (
        <label className="MY AIO-card p-5 rounded-3xl border-2 border-dashed border-gray-300 text-center cursor-pointer hover:bg-gray-50 transition flex flex-col items-center gap-4">
        ...
        <div className="MY AIO-card p-6 rounded-3xl border-2 shadow-xl space-y-5">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="MY AIO-btn-primary w-14 h-14 rounded-full flex items-center justify-center"
            >
      ...
      {/* RECORDING */}
      <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-4 mt-3 mb-3">
        <h4 className="text-xl font-bold flex items-center gap-3">
