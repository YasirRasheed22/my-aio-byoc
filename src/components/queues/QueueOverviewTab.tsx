  ...
  return (
    <div className="space-y-10 p-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-3">
        ...
        {/* Total Calls */}
        <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl flex items-center gap-4">
        ...
        {/* Answered */}
        <div className="MY AIO-card p-6 rounded-3xl border-2 shadow-xl flex items-center gap-4">
      ...
      {/* WAIT TIMES */}
      <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl grid grid-cols-1 md:grid-cols-3 gap-8 mt-3">
      ...
      {/* DISTRIBUTION METHOD */}
      <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-3 mt-3 mb-5">
        <h4 classname="text-xl font-bold">Call Distribution Method</h4>

        <select className="MY AIO-input w-full text-lg">
