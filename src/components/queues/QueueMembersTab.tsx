    ...
    <div className="space-y-10 p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="MY AIO-btn-primary px-6 py-3 flex items-center gap-3 text-lg"
        >
          <UserPlus size={22} />
          Add Agents
        </button>
      ...
      <div className="relative w-96">
        ...
        <input
          ...
          className="MY AIO-input pl-14 pr-4 py-3 rounded-2xl"
          placeholder="Search agents..."
        />
      </div>

      {/* MEMBERS TABLE */}
      <div className="MY AIO-card p-6 rounded-3xl border-2 shadow-xl overflow-x-auto mt-4 mb-5">
      ...
      {showAddModal && (
        <div
          className="MY AIO-modal-backdrop"
          onClick={() => setShowAddModal(false)}
        >
          <div
            className="MY AIO-modal max-w-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="MY AIO-modal-header">
              <h2 className="MY AIO-modal-title">Add Agents to Queue</h2>
              <button
                className="MY AIO-close-btn"
                onClick={() => setShowAddModal(false)}
              >
                <XCircle size={28} />
              </button>
            ...
            <div className="MY AIO-modal-body space-y-6">
              ...
              <div className="space-y-4 max-h-80 overflow-y-auto pr-2">
                {allAgents.map((agent) => (
                  <div
                    key={agent.id}
                    className="p-4 MY AIO-card rounded-2xl border flex justify-between items-center"
                  >
                    ...
                    <button className="MY AIO-btn-primary px-5 py-2 text-sm">
                      Add
                    </button>
                  </div>
                ))}
            ...
            <div className="MY AIO-modal-footer">
              <button
                className="MY AIO-btn-secondary px-6 py-3"
                onClick={() => setShowAddModal(false)}
              >
                Close
              </button>
