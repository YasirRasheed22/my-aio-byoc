...
export default function QueueAnnouncementTab() {
  ...
  return (
    <div className="space-y-10 p-4">
      ...
      {/* UPLOAD AREA */}
      {!uploadedFile && (
        <label className="MY AIO-card p-3 rounded-3xl border-2 border-dashed border-gray-300 cursor-pointer hover:bg-gray-50 transition flex flex-col items-center gap-4 text-center">
      ...
      {/* ANNOUNCEMENT FILE */}
      {uploadedFile && (
        <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-6">
      ...
      {/* TTS SECTION */}
      <div className="MY AIO-card p-3 mt-3 rounded-3xl border-2 shadow-xl space-y-6">
      ...
      <div className="MY AIO-card p-3 mt-3 rounded-3xl border-2 shadow-xl space-y-6">
        ...
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            ...
            className="w-6 h-6 MY AIO-checkbox"
          />
