      ...
      {enabled && (
        <>
          ...
          <div className="space-y-4">
            ...
            {!uploadedFile && (
              <label className="MY AIO-card p-4 rounded-3xl border-2 border-dashed border-gray-300 cursor-pointer hover:bg-gray-50 transition flex flex-col items-center gap-4 text-center">
            ...
            {uploadedFile && (
              <div className="MY AIO-card p-6 rounded-3xl border-2 shadow-xl space-y-6">
          ...
          <div className="MY AIO-card p-3 rounded-3xl border-2 shadow-xl space-y-6 mt-3">
            ...
            <textarea
              className="MY AIO-input w-full text-lg h-32"
          ...
          {/* EMAIL NOTIFICATIONS */}
          <div className="MY AIO-card p-4 rounded-3xl border-2 shadow-xl space-y-6 mt-3">
            <h4 className="text-xl font-bold flex items-center gap-3">
            ...
            <button
              onClick={addEmail}
              className="MY AIO-btn-secondary flex items-center gap-2 px-4 py-2 mt-3"
            >
